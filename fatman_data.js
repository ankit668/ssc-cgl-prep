...
`,
    "mcqs": [
        ...
        {
            "question": "The <strong>Sun</strong>'s core temperature is approximately:",
            "options": [
                "5800 K",
                "1.5 Million K",
                "15.7 Million K",
        ...
        },
        {
            ...
            "correct": 1,
            "explanation": "<strong>Mercury</strong> is the smallest planet and completes a revolution in just 88 days.",
            "topic": "Physical Geography"
        },
        {
            "question": "What gas gives <strong>Uranus</strong> and <strong>Neptune</strong> their characteristic greenish-blue color?",
            "options": [
                "Hydrogen",
                "Helium",
                "Methane",
        ...
        {
            "question": "Who discovered the planet <strong>Neptune</strong> in 1846?",
            "options": [
                "William Herschel",
                "Johann Galle",
                "Clyde Tombaugh",
            ...
            "correct": 1,
            "explanation": "<strong>Neptune</strong> was mathematically predicted and observed by Johann Galle in 1846.",
            "topic": "Physical Geography"
        },
        {
            "question": "What is the highest peak on the <strong>Moon</strong>?",
            "options": [
                "Olympus Mons",
                "Mt. Leibniz",
                "Mt. Everest",
            ...
            "correct": 1,
            "explanation": "Mt. Leibniz is the highest peak on the <strong>Moon</strong>.",
            "topic": "General Geography"
        },
        {
            "question": "At what astronomical position is the <strong>Earth</strong> closest to the <strong>Sun</strong>?",
            "options": [
                "Aphelion",
                "Perigee",
                "Perihelion",
            ...
            "correct": 2,
            "explanation": "Perihelion occurs around January 3 when <strong>Earth</strong> is closest to the <strong>Sun</strong>.",
            "topic": "Physical Geography"
        },
        {
            ...
            "correct": 0,
            "explanation": "1 degree of <strong>latitude</strong> corresponds to approximately 111 km.",
            "topic": "Physical Geography"
        },
        {
        ...
        {
            "question": "Which type of <strong>igneous</strong> intrusion is lens-shaped and found at anticlines and synclines?",
            "options": [
                "Batholith",
                "Laccolith",
                "Phacolith",
            ...
            "correct": 2,
            "explanation": "Phacoliths are lens-shaped intrusions associated with folded <strong>sedimentary</strong> rocks.",
            "topic": "Physical Geography"
        },
        {
            ...
            "correct": 3,
            "explanation": "Granite (<strong>igneous</strong>) metamorphoses into Gneiss under heat and pressure.",
            "topic": "Physical Geography"
        },
        {
        ...
        },
        {
            ...
            "correct": 3,
            "explanation": "The <strong>Thermosphere</strong> contains the electrically charged particles of the Ionosphere.",
            "topic": "Physical Geography"
        },
        {
        ...
        {
            "question": "The <strong>Tropic of Cancer</strong> does NOT pass through which state?",
            "options": [
                "Gujarat",
                "Chhattisgarh",
                "Manipur",
        ...
        },
        {
            ...
            "options": [
                "<strong>Zoji La</strong>",
                "<strong>Rohtang Pass</strong>",
                "<strong>Nathu La</strong>",
                "<strong>Shipki La</strong>"
            ],
            "correct": 0,
            "explanation": "<strong>Zoji La</strong> connects Srinagar (Kashmir) to Leh (Ladakh).",
            "topic": "Indian Geography"
        },
        {
        ...
        {
            "question": "Which is the highest peak of the <strong>Aravalli</strong> range?",
            "options": [
                "Anaimudi",
                "Dodabetta",
                "Guru Shikhar",
            ...
            "correct": 2,
            "explanation": "Guru Shikhar (in Mt. Abu) is the highest peak of the old fold <strong>Aravalli</strong> mountains.",
            "topic": "Indian Geography"
        },
        {
            "question": "Through which pass does the <strong>Sutlej</strong> river enter India?",
            "options": [
                "Bara-Lacha La",
                "<strong>Shipki La</strong>",
                "Lipu Lekh",
                "<strong>Niti Pass</strong>"
            ],
            "correct": 1,
            "explanation": "<strong>Sutlej</strong> enters Himachal Pradesh from Tibet through <strong>Shipki La</strong>.",
            "topic": "Indian Geography"
        },
        {
            "question": "What is the name of the longest non-polar glacier in India, located in the <strong>Karakoram</strong> range?",
            "options": [
                "Baltoro",
                "Siachen",
                "Hispar",
        ...
        {
            "question": "Which layer of <strong>Earth</strong>'s interior is primarily composed of Nickel and Iron (NiFe)?",
            "options": [
                "Crust",
                "Mantle",
                "Asthenosphere",
        ...
        {
            "question": "Which is the highest peak in the <strong>Western Ghats</strong> and all of South India?",
            "options": [
                "Dodabetta",
                "Guru Shikhar",
                "Anamudi",
            ...
            "correct": 2,
            "explanation": "Anamudi (2695m) in Kerala is the highest peak in the <strong>Western Ghats</strong> and South India.",
            "topic": "Indian Geography"
        },
        {
            "question": "The <strong>Eastern Ghats</strong> and <strong>Western Ghats</strong> meet at which mountain range?",
            "options": [
                "<strong>Cardamom</strong> Hills",
                "<strong>Nilgiri</strong> Hills",
                "Palani Hills",
                "Nallamala Hills"
            ],
            "correct": 1,
            "explanation": "The Eastern and <strong>Western Ghats</strong> converge at the <strong>Nilgiri</strong> Hills in Tamil Nadu.",
            "topic": "Indian Geography"
        },
        {
            "question": "A drainage pattern that resembles the branching roots of a tree (like the <strong>Ganga</strong> river system) is called?",
            "options": [
                "Trellis",
                "Radial",
                "Dendritic",
        ...
        {
            "question": "According to the <strong>Indus</strong> Water Treaty (1960), India has control over the waters of which three rivers?",
            "options": [
                "<strong>Indus</strong>, <strong>Jhelum</strong>, <strong>Chenab</strong>",
                "<strong>Ravi</strong>, <strong>Beas</strong>, <strong>Sutlej</strong>",
                "<strong>Chenab</strong>, <strong>Ravi</strong>, <strong>Beas</strong>",
                "<strong>Indus</strong>, <strong>Sutlej</strong>, <strong>Beas</strong>"
            ],
            "correct": 1,
            "explanation": "India controls the eastern rivers: <strong>Ravi</strong>, <strong>Beas</strong>, and <strong>Sutlej</strong>. Pakistan controls the western rivers: <strong>Indus</strong>, <strong>Jhelum</strong>, <strong>Chenab</strong>.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "question": "Which river is known as the 'Dakshin <strong>Ganga</strong>' and is the largest peninsular river in India?",
            "options": [
                "<strong>Krishna</strong>",
                "<strong>Kaveri</strong>",
                "<strong>Mahanadi</strong>",
                "<strong>Godavari</strong>"
            ],
            "correct": 3,
            "explanation": "<strong>Godavari</strong> (1465km) is the longest peninsular river and is known as Dakshin <strong>Ganga</strong> or Vridha <strong>Ganga</strong>.",
            "topic": "Indian Geography"
        },
        {
            ...
            "correct": 0,
            "explanation": "<strong>Narmada</strong> and Tapti flow west through rift valleys and form estuaries instead of deltas.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "question": "Which river crosses the <strong>Tropic of Cancer</strong> twice?",
            "options": [
                "<strong>Luni</strong>",
                "<strong>Sabarmati</strong>",
                "<strong>Mahi</strong>",
                "<strong>Damodar</strong>"
            ],
            "correct": 2,
            "explanation": "The <strong>Mahi</strong> river originates in the Vindhyas and crosses the <strong>Tropic of Cancer</strong> twice.",
            "topic": "Indian Geography"
        },
        {
            ...
            "options": [
                "Bhakra Nangal Dam",
                "<strong>Hirakud</strong> Dam",
                "<strong>Tehri</strong> Dam",
                "<strong>Sardar Sarovar</strong> Dam"
            ],
            "correct": 2,
            "explanation": "The <strong>Tehri</strong> Dam on the Bhagirathi River in Uttarakhand is the highest dam in India (261m).",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "question": "The pre-<strong>monsoon</strong> showers in West Bengal and Assam that help in the growth of jute and tea crops are known as?",
            "options": [
                "Mango Showers",
                "Blossom Showers",
            ...
            "correct": 2,
            "explanation": "Nor'westers, locally known as Kal Baisakhi, bring pre-<strong>monsoon</strong> rain to Bengal and Assam.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "question": "The El Ni\u00f1o phenomenon, which negatively impacts the Indian <strong>Monsoon</strong>, is characterized by?",
            "options": [
                "Cooling of the Indian Ocean",
                "Warming of the eastern-central Pacific Ocean",
                "Cooling of the eastern-central Pacific Ocean",
        ...
        },
        {
            ...
            "correct": 1,
            "explanation": "Tropical Deciduous Forests (<strong>Monsoon</strong> forests) shed their leaves to conserve water in summer.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
        ...
        },
        {
            ...
            "options": [
                "Bhakra Nangal",
                "<strong>Hirakud</strong>",
                "<strong>Tehri</strong>",
                "<strong>Nagarjuna Sagar</strong>"
            ],
            "correct": 1,
            "explanation": "<strong>Hirakud</strong> Dam, built on the <strong>Mahanadi</strong> River in Odisha, is the longest earthen dam in the world.",
            "topic": "Physical Geography"
        },
        {
        ...
        {
            "question": "Which of the following represents the land between the <strong>Beas</strong> and <strong>Sutlej</strong> rivers?",
            "options": [
                "Bari Doab",
                "Bist Doab",
                "Rechna Doab",
            ...
            "correct": 1,
            "explanation": "Bist Doab is between <strong>Beas</strong> and <strong>Sutlej</strong>. (Trick: B for <strong>Beas</strong>, st for <strong>Sutlej</strong>).",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "question": "What was the ancient name of the <strong>Chenab</strong> river in the Vedic period?",
            "options": [
                "Vitasta",
                "Purushni",
                "Askini",
            ...
            "correct": 2,
            "explanation": "The ancient name of <strong>Chenab</strong> is Askini. <strong>Jhelum</strong> is Vitasta, <strong>Ravi</strong> is Purushni, <strong>Sutlej</strong> is Shutudri.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "question": "Keibul Lamjao, the world's only floating national park, is located on which lake?",
            "options": [
                "<strong>Chilika</strong> Lake",
                "<strong>Wular</strong> Lake",
                "<strong>Vembanad</strong> Lake",
                "<strong>Loktak</strong> Lake"
            ],
            "correct": 3,
            "explanation": "Keibul Lamjao National Park is located on <strong>Loktak</strong> Lake in Manipur, famous for floating islands called phumdis.",
            "topic": "Indian Geography"
        },
        {
        ...
        {
            "question": "Winter rainfall in northwestern India, which is crucial for <strong>Rabi</strong> crops, is caused by?",
            "options": [
                "Northeast <strong>Monsoon</strong>",
                "Southwest <strong>Monsoon</strong>",
        ...
        {
            "question": "Which of the following is the local name for 'slash and burn' agriculture (shifting cultivation) in the <strong>Western Ghats</strong>?",
            "options": [
                "Jhum",
                "Kumari",
                "Podu",
            ...
            "correct": 1,
            "explanation": "Shifting cultivation is called Kumari in the <strong>Western Ghats</strong>, Jhum in North-East, and Podu in Andhra Pradesh.",
            "topic": "Indian Geography"
        },
        {
        ...
        {
            "question": "Which river crosses the <strong>Equator</strong> twice?",
            "options": [
                "Nile River",
                "Amazon River",
                "Congo (Zaire) River",
            ...
            "correct": 2,
            "explanation": "The Congo (or Zaire) River in Africa crosses the <strong>equator</strong> twice.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
        ...
        },
        {
            ...
            "options": [
                "<strong>Brahmaputra</strong> (Sadiya to Dhubri)",
                "West Coast Canal",
                "<strong>Ganga</strong> (Allahabad to Haldia)",
                "<strong>Godavari</strong> stretch"
            ],
            "correct": 2,
            "explanation": "NW-1 is the longest waterway (1,620 km) located on the <strong>Ganga</strong>-Bhagirathi-<strong>Hooghly</strong> river system from Allahabad (Prayagraj) to Haldia.",
            "topic": "Indian Geography"
        },
        {
            "question": "Which line of <strong>latitude</strong> serves as the international boundary between the USA and Canada?",
            "options": [
                "38th Parallel",
                "49th Parallel",
                "17th Parallel",
        ...
        },
        {
            ...
            "correct": 0,
            "explanation": "The Kerch Strait connects the Black Sea and the Sea of Azov.",
            "options": [
                "Sea of Azov",
                "Caspian Sea",
                "Mediterranean Sea",
        ...
        },
        {
            ...
            "options": [
                "A high-yielding variety of Wheat",
                "A high-yielding variety of Rice",
        ...
        {
            "question": "Halley's Comet, which has a highly elliptical orbit, is visible from <strong>Earth</strong> once every how many years?",
            "options": [
                "56 years",
                "76 years",
                "86 years",
        ...
        },
        {
            ...
            "options": [
                "<strong>Earth</strong> and <strong>Mars</strong>",
                "<strong>Mars</strong> and <strong>Jupiter</strong>",
                "<strong>Jupiter</strong> and <strong>Saturn</strong>",
                "<strong>Venus</strong> and <strong>Earth</strong>"
            ],
            "correct": 1,
            "explanation": "The asteroid belt is found between the orbits of <strong>Mars</strong> and <strong>Jupiter</strong>.",
            "topic": "Physical Geography"
        },
        {
            "question": "How much time does the light reflected from the <strong>Moon</strong> take to reach <strong>Earth</strong>?",
            "options": [
                "1.26 seconds",
            ...
            "correct": 0,
            "explanation": "Light from the <strong>Moon</strong> takes approximately 1.26 to 1.3 seconds to reach <strong>Earth</strong>.",
            "topic": "Physical Geography"
        },
        {
            ...
            "correct": 2,
            "explanation": "There are 90 latitudes in the north, 90 in the south, and 1 <strong>equator</strong>. 90+90+1 = 181 latitudes (though only 179 are circles, as poles are points).",
            "topic": "Physical Geography"
        },
        {
            "question": "What is the axial tilt of the <strong>Earth</strong> relative to its orbital plane?",
            "options": [
                "66.5\u00b0",
                "23.5\u00b0",
                "90\u00b0",
            ...
            "correct": 1,
            "explanation": "The <strong>Earth</strong> is tilted on its axis at an angle of 23.5 degrees.",
            "topic": "Physical Geography"
        },
        {
            "question": "What is the most abundant element found in the <strong>Earth</strong>'s crust by weight?",
            "options": [
                "Silicon",
                "Aluminium",
                "Iron",
        ...
        {
            "question": "What is the most abundant METAL found in the <strong>Earth</strong>'s crust?",
            "options": [
                "Iron",
                "Copper",
                "Aluminium",
        ...
        {
            "question": "Which of the following gases is the third most abundant in the <strong>Earth</strong>'s atmosphere?",
            "options": [
                "Carbon Dioxide",
                "Argon",
                "Helium",
        ...
        {
            "question": "The <strong>Pir Panjal</strong> and <strong>Dhauladhar</strong> ranges are part of which Himalayan division?",
            "correct": 2,
            "explanation": "The <strong>Pir Panjal</strong> and <strong>Dhauladhar</strong> ranges are the major ranges of the Lesser <strong>Himalayas</strong> (Himachal).",
            "options": [
                "Trans <strong>Himalayas</strong>",
                "Greater <strong>Himalayas</strong> (Himadri)",
                "Lesser <strong>Himalayas</strong> (Himachal)",
                "Shiwaliks"
            ],
            "topic": "Indian Geography"
        },
        ...
        },
        {
            ...
            "options": [
                "<strong>Kolleru</strong> Lake",
                "<strong>Pulicat</strong> Lake",
                "<strong>Vembanad</strong> Lake",
                "Hussain Sagar"
            ],
            "correct": 1,
            "explanation": "<strong>Pulicat</strong> Lake is India's second-largest brackish water lake, located on the border of AP and TN.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "question": "Which soil type is formed primarily by the weathering of ancient crystalline and <strong>metamorphic</strong> rocks and gets its color from iron diffusion?",
            "options": [
                "Alluvial Soil",
                "Black Soil",
                "Red Soil",
            ...
            "correct": 2,
            "explanation": "Red soil is formed from crystalline <strong>igneous</strong>/<strong>metamorphic</strong> rocks and is red due to the presence of iron oxide.",
            "topic": "Physical Geography"
        },
        {
        ...
        ,
    {
        ...
        "options": ["Diphu Pass", "<strong>Jelep La</strong>", "<strong>Nathu La</strong>", "Lipu Lekh"],
        "correct": 0,
        "explanation": "Diphu Pass, Pangsau Pass, and Dihang Pass connect Arunachal Pradesh with Myanmar. <strong>Nathu La</strong> and <strong>Jelep La</strong> are in Sikkim."
    },
    {
        "id": "geo_deep_2",
        "topic": "Physical Geography",
        ...
        "correct": 1,
        "explanation": "Mangsha Dhura, Traill's Pass, <strong>Mana Pass</strong>, <strong>Niti Pass</strong>, and Lipu Lekh are major passes in Uttarakhand."
    },
    {
        "id": "geo_deep_3",
        "topic": "Rivers, Lakes & Climate",
        "question": "Which river is formed by the confluence of the Sankh and South Koel rivers near Rourkela?",
        "options": ["Baitarani", "Brahmani", "<strong>Subarnarekha</strong>", "<strong>Damodar</strong>"],
        "correct": 1,
    ...
    },
    {
        ...
        "options": ["<strong>Mahanadi</strong>", "<strong>Godavari</strong>", "<strong>Damodar</strong>", "<strong>Subarnarekha</strong>"],
        "correct": 2,
        "explanation": "The <strong>Damodar</strong> River originates and flows through a rift valley in the Chotanagpur Plateau. It joins the Hugli river. Also known as the 'Sorrow of Bengal'."
    }
    ,
        {
            "question": "Which pass in Arunachal Pradesh connects the Tawang district with China?",
            "options": ["<strong>Zoji La</strong>", "Bum La", "<strong>Nathu La</strong>", "<strong>Shipki La</strong>"],
            "correct": 1,
            "explanation": "Bum La connects Tawang district (Arunachal Pradesh) with China at 5,100m altitude.",
            "topic": "Indian Geography"
        },
        {
            "question": "The 'Queen of <strong>Satpura</strong>' hill station is in which state?",
            "options": ["Maharashtra", "Gujarat", "Madhya Pradesh", "Chhattisgarh"],
            "correct": 2,
            "explanation": "Pachmarhi (MP) is the 'Queen of <strong>Satpura</strong>'. Dhupgarh (1350m) is its highest point.",
            "topic": "Indian Geography"
        },
        {
            ...
            "correct": 3,
            "explanation": "Asirgarh Fort (Burhanpur, MP) controls the gap between <strong>Vindhya</strong> and <strong>Satpura</strong> ranges.",
            "topic": "Indian Geography"
        },
        {
        ...
        },
        {
            ...
            "options": ["<strong>Narmada</strong>", "<strong>Mahanadi</strong>", "Indravati", "<strong>Godavari</strong>"],
            "correct": 2,
            "explanation": "Chitrakote Falls on Indravati River (Chhattisgarh) is the widest waterfall in India.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "question": "<strong>Hirakud</strong> Dam (longest dam in India) is on which river?",
            "options": ["<strong>Godavari</strong>", "<strong>Mahanadi</strong>", "<strong>Krishna</strong>", "<strong>Subarnarekha</strong>"],
            "correct": 1,
            "explanation": "<strong>Hirakud</strong> Dam (25.8 km long) on <strong>Mahanadi</strong> River, Odisha. India's first major multipurpose dam.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "question": "Which river is called the 'Sorrow of Bengal'?",
            "options": ["<strong>Kosi</strong>", "<strong>Damodar</strong>", "<strong>Subarnarekha</strong>", "<strong>Mahanadi</strong>"],
            "correct": 1,
            "explanation": "<strong>Damodar</strong> = Sorrow of Bengal. <strong>Kosi</strong> = Sorrow of Bihar. <strong>Mahanadi</strong> = Sorrow of Odisha.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
        ...
        },
        {
            ...
            "correct": 1,
            "explanation": "Kal Baisakhi (pre-<strong>monsoon</strong> violent thunderstorms) in WB, Assam, Bangladesh are beneficial for Jute and Tea.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
        ...
        {
            "question": "<strong>Pal Ghat</strong> (Palakkad Gap) connects which two cities and is the widest pass of the <strong>Western Ghats</strong>?",
            "options": ["Mumbai to Nashik", "Mumbai to Pune", "Coimbatore to Thrissur", "Goa to Belgaum"],
            "correct": 2,
            "explanation": "Palakkad Gap (30 km wide) connects Coimbatore (TN) with Thrissur (Kerala). Widest and lowest pass in <strong>Western Ghats</strong>.",
            "topic": "Indian Geography"
        },
        {
            "question": "Largest masonry dam in the world is located in India. Which dam?",
            "options": ["Bhakra Nangal", "<strong>Tehri</strong> Dam", "<strong>Nagarjuna Sagar</strong> Dam", "<strong>Sardar Sarovar</strong>"],
            "correct": 2,
            "explanation": "<strong>Nagarjuna Sagar</strong> Dam on <strong>Krishna</strong> River (Telangana) is the world's largest masonry dam.",
            "topic": "Indian Geography"
        },
        {
        ...
        {
            "question": "<strong>Loktak</strong> Lake in Manipur is famous for:",
            ...
            "correct": 1,
            "explanation": "<strong>Loktak</strong> has floating vegetation islands called 'phumdis'. Keibul Lamjao is the world's only floating National Park.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
        ...
        },
        {
            ...
            "options": ["Sankh and North Koel", "Sankh and South Koel at Rourkela", "Gomti and <strong>Son</strong>", "Indravati and Wainganga"],
            "correct": 1,
        ...
        },
        {
            ...
            "options": ["Cauvery", "<strong>Tungabhadra</strong>", "Sharavati", "Bedti"],
            "correct": 2,
            "explanation": "Jog Falls (253m) is on the Sharavati River. 4 cascades: Raja, Rani, Rover, Rocket.",
            "topic": "Indian Geography"
        },
        {
            "question": "The <strong>Nathu La</strong> Pass connects India with which country?",
            "options": ["Nepal", "Bhutan", "China (Tibet)", "Myanmar"],
            "correct": 2,
            "explanation": "<strong>Nathu La</strong> (4,310m) connects Sikkim with Chumbi Valley in Tibet (China). Reopened for trade in 2006.",
            "topic": "Indian Geography"
        },
        {
            "question": "<strong>Mahi</strong> River is notable for which geographical distinction?",
            "options": ["It is longest west-flowing river", "It drains into Rann of Kutch", "It crosses the <strong>Tropic of Cancer</strong> twice", "It flows between <strong>Vindhya</strong> and <strong>Satpura</strong>"],
            "correct": 2,
            "explanation": "<strong>Mahi</strong> River (originates Dhar, MP) crosses the <strong>Tropic of Cancer</strong> TWICE on its way to the Gulf of Khambhat.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "question": "What is the Sadbhawna Shikhar?",
            "options": ["Highest peak of <strong>Satpura</strong>", "Highest peak of <strong>Vindhya</strong> Range", "Highest peak of <strong>Eastern Ghats</strong>", "Highest peak of Aravallis"],
            "correct": 1,
            "explanation": "Sadbhawna Shikhar is the highest point of the <strong>Vindhya</strong> Range. Vindhyas are block mountains that separate the Indo-Gangetic plain from the Deccan.",
            "topic": "Indian Geography"
        },
        {
    ...
    "flashcards": [
        {
            "front": "What is the closest galaxy to the <strong>Milky Way</strong>?",
            "back": "<strong>Andromeda</strong> (M-31).",
            "topic": "General Geography"
        },
        {
            "front": "Which star is nearest to <strong>Earth</strong> after the <strong>Sun</strong>?",
            "back": "Proxima Centauri.",
            "topic": "Physical Geography"
        },
        {
            "front": "What is the Chandrasekhar Limit?",
            "back": "1.44 times the mass of the <strong>Sun</strong>.",
            "topic": "General Geography"
        },
        {
            "front": "Which planet rotates the fastest?",
            "back": "<strong>Jupiter</strong> (9 hours 55 minutes).",
            "topic": "Physical Geography"
        },
        {
            "front": "Which planet is known as the Green Planet?",
            "back": "<strong>Uranus</strong> (due to Methane).",
            "topic": "Physical Geography"
        },
        {
            "front": "Who discovered <strong>Pluto</strong>?",
            "back": "Clyde Tombaugh.",
            "topic": "Agriculture, Soils & Minerals"
        },
        {
            "front": "What is the shape of the <strong>Earth</strong> called?",
            "back": "Geoid or Oblate Spheroid.",
            "topic": "Physical Geography"
        },
        {
            "front": "What happens during Perihelion?",
            "back": "<strong>Earth</strong> is closest to the <strong>Sun</strong> (Jan 3).",
            "topic": "Physical Geography"
        },
        {
            "front": "How many kilometers are in 1 degree of <strong>latitude</strong>?",
            "back": "111 km.",
            "topic": "Physical Geography"
        },
        {
            "front": "What is a Syzygy?",
            "back": "<strong>Sun</strong>, <strong>Moon</strong>, and <strong>Earth</strong> aligned in a straight line.",
            "topic": "Physical Geography"
        },
        {
        ...
        },
        {
            ...
            "back": "Intrusive <strong>Igneous</strong> Rock.",
            "topic": "Physical Geography"
        },
        {
        ...
        },
        {
            ...
            "back": "<strong>Stratosphere</strong>.",
            "topic": "Physical Geography"
        },
        {
            "front": "In which atmospheric layer do meteors burn up?",
            "back": "<strong>Mesosphere</strong>.",
            "topic": "Physical Geography"
        },
        {
        ...
        },
        {
            ...
            "back": "<strong>Zoji La</strong>.",
            "topic": "Indian Geography"
        },
        {
            "front": "Through which pass does the <strong>Sutlej</strong> river enter India?",
            "back": "<strong>Shipki La</strong> (Himachal Pradesh).",
            "topic": "Indian Geography"
        },
        {
            "front": "Which is the highest peak in the <strong>Aravalli</strong> range?",
            "back": "Guru Shikhar.",
            "topic": "Indian Geography"
        },
        {
        ...
        {
            "front": "Where do the Eastern and <strong>Western Ghats</strong> meet?",
            "back": "<strong>Nilgiri</strong> Hills.",
            "topic": "Indian Geography"
        },
        {
            "front": "Which pass connects Mumbai to Pune?",
            "back": "<strong>Bhor Ghat</strong>.",
            "topic": "Indian Geography"
        },
        {
            "front": "Which river crosses the <strong>Tropic of Cancer</strong> twice?",
            "back": "<strong>Mahi</strong> River.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "front": "Which river is known as 'Dakshin <strong>Ganga</strong>'?",
            "back": "<strong>Godavari</strong>.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "front": "Which two major peninsular rivers flow west into the Arabian Sea?",
            "back": "<strong>Narmada</strong> and Tapti.",
            "topic": "Indian Geography"
        },
        {
            "front": "Which is the highest dam in India?",
            "back": "<strong>Tehri</strong> Dam (Uttarakhand).",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "front": "Which is the longest earthen dam in the world?",
            "back": "<strong>Hirakud</strong> Dam (Odisha).",
            "topic": "Physical Geography"
        },
        {
            "front": "Which is the largest freshwater lake in India?",
            "back": "<strong>Wular</strong> Lake (J&K).",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "front": "What does El Ni\u00f1o do to the Indian <strong>Monsoon</strong>?",
        ...
        {
            "front": "What is the longest tributary of the <strong>Ganga</strong>?",
            "back": "<strong>Yamuna</strong> River.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "front": "Where does the Alaknanda meet the Bhagirathi to form the <strong>Ganga</strong>?",
            "back": "Devprayag.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "front": "What is the ancient name of the <strong>Jhelum</strong> river?",
            "back": "Vitasta.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "front": "What is the ancient name of the <strong>Ravi</strong> river?",
            "back": "Purushni.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "front": "Which Doab lies between the <strong>Ravi</strong> and <strong>Chenab</strong> rivers?",
            "back": "Rechna Doab.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
        ...
        {
            "front": "What causes winter rainfall in Northwestern India (beneficial for <strong>Rabi</strong> crops)?",
        ...
        {
            "front": "Which river crosses the <strong>Equator</strong> twice?",
        ...
        {
            "front": "Which National Waterway is situated on the <strong>Brahmaputra</strong> River?",
        ...
        },
        {
            ...
            "back": "Approximately 2 hours (30\u00b0 <strong>longitude</strong> diff).",
            "topic": "Physical Geography"
        },
        {
        ...
        {
            "front": "Which is the highest peak of the <strong>Satpura</strong> Range?",
            "back": "Dhupgarh.",
            "topic": "Indian Geography"
        },
        {
            "front": "What are 'Duns' in the <strong>Himalayas</strong>?",
            "back": "Longitudinal valleys between Lesser <strong>Himalayas</strong> and Shiwaliks (e.g., Dehradun).",
            "topic": "Indian Geography"
        },
        {
            "front": "Which river forms the world's largest riverine island, Majuli?",
            "back": "<strong>Brahmaputra</strong>.",
            "topic": "Indian Geography"
        },
        {
            "front": "Which river is known as the 'Sorrow of Bengal'?",
            "back": "<strong>Damodar</strong> River.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "front": "Which river is known as the 'Sorrow of Bihar'?",
            "back": "<strong>Kosi</strong> River.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
            "front": "What is an endorheic river? Give an Indian example.",
            "back": "A river that drains inland and doesn't reach the sea. Example: <strong>Luni</strong> River.",
            "topic": "Rivers, Lakes & Climate"
        },
        {
        ...
        },
        {
            ...
            "back": "<strong>Sambhar</strong> Lake (Rajasthan).",
            "topic": "Rivers, Lakes & Climate"
        },
        {
    ...
    { "topic": "Rivers, Lakes & Climate", "front": "Which river's sand contains gold particles, giving it the name 'Streak of Gold'?", "back": "<strong>Subarnarekha</strong> River (originates in Ranchi Plateau, Jharkhand)." },
    { "topic": "Rivers, Lakes & Climate", "front": "<strong>Godavari</strong> tributaries trick (M S W W I P P P)?", "back": "Manjira, Sabari, Wainganga, Wardha, Indravati, Penganga, Purna, Pranhita." },
