window.fatmanGeography = {
    ...
    "notes": `
        ...
        <ul>
            <li><strong>Theories of Universe:</strong> <em>Big Bang Theory</em> (Georges Lemaître, 1927) is the most accepted. <em>Steady State Theory</em> (Fred Hoyle). <em>Nebular Hypothesis</em> (Kant & Laplace) for solar system formation.</li>
