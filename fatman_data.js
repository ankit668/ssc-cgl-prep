window.fatmanGeography = {
    ...
    "notes": `
        ...
        <ul>
            ...
            <li><strong>Galaxies & Stars:</strong> Milky Way (Spiral shape). Andromeda is the closest galaxy. <em>Proxima Centauri</em> is the closest star to the Sun. <em>Sirius</em> (Dog Star) is the brightest star. 1 Light Year = $9.46 \times 10^{12}$ km.</li>
            <li><strong>The Sun:</strong> Composed of Hydrogen (71%) and Helium (26.5%). Surface temp: 6000�C. Core temp: 15 million �C. Energy source: Nuclear Fusion. Layers: Photosphere (visible surface), Chromosphere, Corona (outermost, visible during eclipse).</li>
            <li><strong>The Planets (Terrestrial vs Jovian):</strong>
                <table style='width:100%; border-collapse: collapse; margin-top: 10px; margin-bottom: 10px; font-size: 0.9em;'>
                    ...
                    <tr><td style='border: 1px solid #334155; padding: 5px;'><strong>Venus</strong></td><td style='border: 1px solid #334155; padding: 5px;'>Hottest planet (CO2 greenhouse effect). Earth's Twin. Morning/Evening Star. Rotates East to West (Retrograde).</td></tr>
                    <tr><td style='border: 1px solid #334155; padding: 5px;'><strong>Earth</strong></td><td style='border: 1px solid #334155; padding: 5px;'>Blue Planet. Densest planet (5.5 g/cm�). Tilted at 23.5�. 1 satellite (Moon).</td></tr>
                    ...
                    <tr><td style='border: 1px solid #334155; padding: 5px;'><strong>Jupiter</strong></td><td style='border: 1px solid #334155; padding: 5px;'>Largest planet. Fastest rotation (9.8 hrs). Giant Red Spot. Largest moon: Ganymede (largest in solar system).</td></tr>
                    <tr><td style='border: 1px solid #334155; padding: 5px;'><strong>Saturn</strong></td><td style='border: 1px solid #334155; padding: 5px;'>Least dense (can float on water). Complex ring system. Largest moon: Titan.</td></tr>
                    <tr><td style='border: 1px solid #334155; padding: 5px;'><strong>Uranus</strong></td><td style='border: 1px solid #334155; padding: 5px;'>Greenish color (Methane). Rotates East to West. Highly tilted axis ("Rolling Planet"). Moon: Titania.</td></tr>
                    <tr><td style='border: 1px solid #334155; padding: 5px;'><strong>Neptune</strong></td><td style='border: 1px solid #334155; padding: 5px;'>Coldest, farthest. Moon: Triton. Discovered by Galle.</td></tr>
                </table>
            </li>
            <li><strong>Asteroids, Meteors, Comets:</strong> Asteroid belt lies between Mars and Jupiter. Ceres is the largest asteroid. Halley's Comet appears every 76 years (next in 2061).</li>
            <li><strong>Earth's Movements:</strong> 
                <ul>
                    <li><em>Rotation:</em> Causes day/night, Coriolis force, tides. Speed: 1670 km/h at equator.</li>
                    <li><em>Revolution:</em> Causes seasons, varying lengths of day/night. Perihelion (closest to sun, Jan 3). Aphelion (farthest, July 4).</li>
                    <li><em>Equinoxes:</em> March 21 (Vernal), Sept 23 (Autumnal). Sun directly over equator.</li>
                    <li><em>Solstices:</em> June 21 (Summer - Sun over Tropic of Cancer). Dec 22 (Winter - Sun over Tropic of Capricorn).</li>
                </ul>
            </li>
            <li><strong>Eclipses:</strong> Solar Eclipse (Moon between Earth & Sun, occurs on New Moon). Lunar Eclipse (Earth between Sun & Moon, occurs on Full Moon). <em>Syzygy</em>: Straight line alignment.</li>
        </ul>

        <h3>2. Earth's Interior, Rocks & Geomorphology</h3>
        <ul>
            ...
            <li><strong>Rocks:</strong>
                <table style='width:100%; border-collapse: collapse; margin-top: 10px; margin-bottom: 10px; font-size: 0.9em;'>
                    ...
                    <tr><td style='border: 1px solid #334155; padding: 5px;'><strong>Igneous (Primary)</strong></td><td style='border: 1px solid #334155; padding: 5px;'>Cooling of magma. No fossils. Intrusive: Granite, Gabbro, Pegmatite. Extrusive: Basalt, Andesite.</td></tr>
        ...
        <ul>
            ...
            <li><strong>Layers of Atmosphere:</strong>
                <ul>
                    <li><em>Troposphere:</em> Lowest, contains all weather events, dust, water vapor. Temp decreases with height (Normal Lapse Rate: 6.5�C per km).</li>
                    <li><em>Stratosphere:</em> Contains Ozone layer (O3, absorbs UV). Temp increases with height. Ideal for flying jet aircraft.</li>
                    <li><em>Mesosphere:</em> Coldest layer. Meteors burn up here.</li>
                    <li><em>Thermosphere/Ionosphere:</em> Contains ions. Reflects radio waves. Auroras (Borealis/Australis) occur here. Temp rises rapidly.</li>
                    <li><em>Exosphere:</em> Outermost layer merging with space.</li>
                </ul>
            </li>
        ...
        <ul>
            ...
            <li><strong>El Ni�o / La Ni�a / ENSO / IOD:</strong>
                <ul>
                    <li><em>El Ni�o:</em> Abnormal WARMING of Central/Eastern Pacific. WEAKENS Indian SW Monsoon → drought.</li>
                    <li><em>La Ni�a:</em> Abnormal COOLING of Pacific. STRENGTHENS Indian Monsoon → floods in India.</li>
...
`,
    ...
    { "front": "What is El Ni�o and its effect on India?", "back": "Abnormal warming of Central/East Pacific Ocean. Effect on India: Weakens the Southwest Monsoon → causes drought.", "topic": "World Geography" },
