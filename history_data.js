const historyData = {
    ...
    notes: `
        ...
        <ul>
            <li><strong>Texts:</strong> <em>Ashtadhyayi</em> (in Sanskrit) written by <strong>Panini</strong> (oldest book on <strong>Sanskrit Grammar</strong> written in 600 BC to 300 BC).</li>
        </ul>
        <h4 style="color:#F59E0B;">Buddhist Literature</h4>
        <ul>
            <li><em>Anguttara Nikaya</em> (In it 16 Mahajanapadas are mentioned).</li>
            <li><em>Digha Nikaya</em> (In it 12 Mahajanapadas are mentioned).</li>
        </ul>
        <h4 style="color:#F59E0B;">Jain Literature</h4>
        <ul>
            <li><em>Bhagavati Sutra</em>.</li>
        </ul>
        <ul>
        ...
        <table border="1" style="border-collapse: collapse; width: 100%; border-color:#334155; margin-bottom:20px;">
            <tr style="background:#0F172A;"><th>Mahajanapadas</th><th>Capital & River</th></tr>
            <tr><td>Anga</td><td>Champa (Ganga)</td></tr>
            <tr><td>Magadh</td><td>Rajagir/ Pataliputra (Ganga & Son)</td></tr>
            <tr><td>Kasi</td><td>Varanasi (Gomti)</td></tr>
            <tr><td>Vatsa</td><td>Kausambi (Ganga)</td></tr>
            <tr><td>Kosala</td><td>Sravasti / Ayodhya (Sarayu)</td></tr>
            <tr><td>Surasena</td><td>Mathura (Yamuna)</td></tr>
            <tr><td>Panchala</td><td>Ahichchhatra / Kampilya (Ganga)</td></tr>
            <tr><td>Kuru</td><td>Indraprastha (Yamuna)</td></tr>
            <tr><td>Matsya</td><td>Viratnagar (Yamuna)</td></tr>
            <tr><td>Chedi/Chetiya</td><td>Sothivati/ Banda (Ken & Betwa)</td></tr>
            <tr><td>Avanti</td><td>Ujjain (North)/ Mahismati (South) (Kshipra & Narmada)</td></tr>
            <tr><td>Gandhar</td><td>Taxila (Indus)</td></tr>
            <tr><td>Kamboj</td><td>Pooncha (Kabul & Kurram)</td></tr>
            <tr><td>Asmaka/Assaka</td><td>Pratishtan/ Paithan/ Potana (Godavari)</td></tr>
            <tr><td>Vajji</td><td>Vaishali (Gandak)</td></tr>
        ...
        <h4 style="color:#F59E0B;">Factors Contributing to the Rise of Mahajanapadas</h4>
        <ul>
            <li><strong>Use of Iron:</strong> Iron tools increased agricultural productivity and supported larger population.</li>
            <li><strong>Urbanisation:</strong> Growth of cities like Rajagriha, Vaishali, Varanasi, Ujjain, Taxila.</li>
            <li><strong>Rise of trade:</strong> Trade got boosted due to trade route and these routes were started to get controlled.</li>
            <li><strong>Decline of Tribal polity:</strong> As the population grew, there was a need to set permanent boundaries.</li>
            <li><strong>Strong military Organisation:</strong> To solve conflicts over fertile land armies need to be organized.</li>
            <li><strong>Social Stratification (Varna System):</strong> Varna system supported the emergences of Kshatriya who controlled territories.</li>
            <li><strong>Geographical Factors:</strong> Ganga plain had fertile alluvial soil which gave more productivity in agriculture.</li>
        </ul>
        ...
        <ul>
            ...
            <li>Availability of <strong>Iron mines</strong> (in <strong>Jharkhand region</strong>).</li>
        </ul>

        <h3>6. Dynasties That Ruled Magadha</h3>
        <h4 style="color:#F59E0B;">Haryanka Dynasty</h4>
        <p><strong>Bimbisara (544 BC-492 BC)</strong></p>
        <ul>
            <li>Title: <strong>Seniya</strong></li>
        ...
        <p><strong>Ajatshatru</strong></p>
        <ul>
            <li>He was the son of <strong>Chellana</strong> and <strong>Bimbisara</strong>.</li>
            <li>He established <strong>Patliputra</strong>.</li>
            <li>He introduced advanced military tech including the <strong>Mahashilakantaka</strong> (a giant catapult) and <strong>Rathmoosai</strong> (a scythe chariot).</li>
            <li>He conquered <strong>Lichchavi</strong> and <strong>Vaishali</strong>.</li>
            <li>He defeated Kosala King and married to his daughter.</li>
            <li>He patronised the <strong>1st Buddhist Council</strong>.</li>
            <li>He later <strong>killed</strong> his father <strong>Bimbisara</strong>.</li>
            <li><strong>He was contemporary of Buddha and Mahavira.</strong></li>
        </ul>
        <p><strong>Udayin</strong></p>
        <ul>
            <li>He shifted the capital temporarily from <strong>Rajgriha to Patliputra</strong> (now: "Patna").</li>
        </ul>
        <h4 style="color:#F59E0B;">Shishunaga Dynasty</h4>
        <ul>
            <li><strong>Founder:</strong> <strong>Shishunaga</strong></li>
            <li>Shishunaga defeated <strong>Nagadasaka</strong>, the last ruler of the Haryanka Dynasty.</li>
            <li>He defeated <strong>Avanti</strong> and merged it with <strong>Magadha</strong>.</li>
            <li><strong>Kalashoka</strong>, the second ruler of the Shishunaga dynasty, permanently shifted the capital to Pataliputra and patronized the <strong>Second Buddhist Council</strong> at Vaishali.</li>
        </ul>
        <h4 style="color:#F59E0B;">Nanda Dynasty</h4>
        <p><strong>Mahapadmananda</strong></p>
        <ul>
            <li>He was the founder of <strong>Nanda dynasty</strong>.</li>
            <li><strong>Title taken:</strong> <strong>Ekarat</strong> (Sole Sovereign) and <strong>Sarvakshatrantaka</strong> (Destroyer of all Kshatriyas).</li>
        </ul>
        <p><strong>Dhananada</strong></p>
        <ul>
            <li>Alexander invaded India during his reign (326 BC). In the battle of Hydaspes Alexander defeated Porus on the banks of Hydaspes (Jhelum) in 326BC.</li>
            <li>He introduced <strong>"Nandopakramani"</strong>, a measuring unit.</li>
            <li>He was the <strong>last king</strong> of Nanda Dynasty.</li>
        </ul>
        <h4 style="color:#F59E0B;">Pottery, Coins, Trade, Terms</h4>
        <ul>
            <li><strong>Pottery:</strong> <strong>Northern black polished wares (NBPW)</strong> were used for pottery.</li>
            <li><strong>Coins:</strong> <strong>Punch-marked coins</strong> made of <strong>silver</strong> were used as the form of money for trade purposes. Gold coins such as <strong>Nishka</strong> and <strong>Satmana</strong> were also used.</li>
            <li><strong>Trade:</strong> Artisans and merchants formed associations called <strong>Shrenis (Guilds)</strong> that were collectively referred to as <strong>Nigama</strong>.</li>
            <li><strong>Craft and Architecture:</strong> Craft was <strong>hereditary</strong>. Iron ploughshare played a crucial role in the empire's agricultural success (<strong>second urbanization after Harappa</strong>).</li>
        </ul>
        <table border="1" style="border-collapse: collapse; width: 100%; border-color:#334155; margin-bottom:20px;">
            <tr style="background:#0F172A;"><th>Terms</th><th>Meaning</th></tr>
            <tr><td>Bhojaka/ Gramabhojaka</td><td>Village Headman</td></tr>
            <tr><td>Gahapatis</td><td>Wealthy property owners, who employed Slaves or Hired Labourers</td></tr>
            <tr><td>Shaulkika/Shulkadhyaksha</td><td>Toll-tax collecting officers</td></tr>
            <tr><td>Bhaga</td><td>Tax (1/6th of produced)</td></tr>
            <tr><td>Bali</td><td>Voluntary Offerings to the king</td></tr>
        </table>
        ...
        <ul>
            ...
            <li><strong>Archeological Evidence:</strong> Pillar edicts, Rock edicts.</li>
            <li>Wooden architecture of Chandragupta Maurya found at <strong>Bulandi Bagh</strong> and <strong>Kumhrar</strong>, discovered by <strong>L. A. Waddell</strong>.</li>
        </ul>

        <h4 style="color:#F59E0B;">Chandragupta Maurya (322 BC-298 BC)</h4>
        <ul>
            <li>He was the <strong>founder of Mauryan Dynasty</strong> and ascended the throne by defeating the last ruler of Nanda Dynasty <strong>Dhanananda</strong>, with the help of <strong>Kautilya</strong> (also known as <strong>Chanakya/Vishnugupta</strong>) in <strong>322 BCE</strong>.</li>
            <li>The Vishnu Purana, explicitly connects Chandragupta to the Nanda dynasty through his mother, Mura, a Shudra concubine of Dhanananda.</li>
            <li><strong>Son:</strong> <strong>Bindusara</strong>.</li>
            <li>He built a department <strong>"Kosthagara"</strong>: For storage of grains (mentioned in <strong>Sohgaura: Copper Plate inscription in Gorakhpur, Uttar Pradesh</strong>).</li>
            <li>He defeated <strong>Seleucus Nicator</strong> (General & Successor Alexander).</li>
        </ul>
        <p><strong>About Seleucus Nicator</strong></p>
        <ul>
            <li>Seleucus Nicator founded <strong>Seleucid Dynasty</strong> (member of Macedonian Greek Dynasty) ruling in Northwestern parts of the Indian subcontinent.</li>
            <li><strong>Megasthenes</strong> was in the court of Seleucus Nicator.</li>
            <li>Chandragupta Maurya defeated Seleucus Nicator and married to his daughter <strong:Helena</strong>.</li>
        </ul>
        
        <h4 style="color:#F59E0B;">Bindusara (297BC-273 BC)</h4>
        <ul>
            <li>He is also known as <strong>Amitrochates</strong> (destroyer of enemies) by the <strong>Greek</strong>.</li>
        ...
        <h4 style="color:#F59E0B;">Ashoka (268 BC-232 BC)</h4>
        <ul>
            <li>Ashoka ascended the throne with the help of <strong>Radhagupta (Minister)</strong>.</li>
            <li>During his father's reign, Ashoka was <strong>governor of Taxila and Ujjain</strong>.</li>
            <li>He fought <strong>Kalinga War</strong> with <strong>Raja Anantha Padmanabha</strong>, the ruler of the <strong>independent kingdom</strong> of Kalinga in 261 BC, <strong>7 years</strong> after his coronation.</li>
            <li>He replaced <strong>Berighosha</strong> (physical conquest) with <strong>Dhammagosha</strong> (cultural conquest) after the Kalinga War.</li>
            <li>He sent his son <strong>Mahendra</strong> and daughter <strong>Sanghamitra</strong> to <strong>Ceylon</strong> (now known as <strong>Sri Lanka</strong>) to spread Buddhism.</li>
            <li>He was succeeded by <strong>Dashrath Maurya</strong> (grandson of Ashoka).</li>
        </ul>

        <h4 style="color:#F59E0B;">Ashokan Edicts</h4>
        <ul>
            <li>Edicts of Ashoka are found in <strong>Rocks and Pillars</strong>.</li>
            <li>There are <strong>14 Major Rock Edicts</strong> of Ashoka meaning a maximum of <strong>14 lines</strong> are engraved in Rocks.</li>
            <li>William Jones (founder of Asiatic Society of Bengal, 1784). <strong>James Princep</strong> was the 1st to decipher Ashokan inscriptions in <strong>1837</strong>.</li>
        </ul>
        <p><strong>Major Rock Edicts</strong></p>
        <ul>
            <li><strong>Total:</strong> 14</li>
            <li><strong>Total languages:</strong> 3 (Prakrit, Greek, Aramaic)</li>
            <li><strong>Total scripts used:</strong> 4 (Brahmi, Kharosthi, Greek, Aramaic)</li>
            <li><strong>Most inscriptions were in:</strong> <strong>Prakrit language in Brahmi script</strong></li>
            <li><strong>Script used in Afghanistan:</strong> Greek and Aramaic</li>
        ...
        <table border="1" style="border-collapse: collapse< width: 100%; border-color:#334155; margin-bottom:20px;">
            <tr><td><strong>** Edict 1</strong></td><td>Prohibits animal slaughter. Ban festive gatherings and the killing of animals. Only two peacocks and one deer were killed in Ashoka's kitchen. He wished to discontinue this practice also.</td></tr>
            <tr><td>Edict 2</td><td>Providing care for man and animals describes Chola, Pandaya, kingdoms of south India.</td></tr>
            <tr><td>Edict 3</td><td>Generosity to Brahmans.</td></tr>
            <tr><td><strong>** Edict 4</strong></td><td><strong>Dhammaghosa over bherighosa.</strong></td></tr>
            <tr><td>Edict 5</td><td>Concerns over policy towards slaves.</td></tr>
            <tr><td>Edict 6</td><td>Welfare measures</td></tr>
            <tr><td><strong>** Edict 7</strong></td><td><strong>Requests tolerance for all religions</strong></td></tr>
            <tr><td>Edict 8</td><td>Describes Ashoka's first Dhammayatra to Bodh Gaya and Bodhi tree</td></tr>
            <tr><td>Edict 9</td><td>Condemns popular ceremonies. Stress on ceremonies of dhamma.</td></tr>
            <tr><td>Edict 10</td><td>Condemns the desire for fame and glory. It stresses the popularity of Dhamma.</td></tr>
            <tr><td>Edict 11</td><td>Elaborates dhamma.</td></tr>
            <tr><td><strong>** Edict 12</strong></td><td><strong>Directed and determined requests for tolerance among different religious sects.</strong></td></tr>
            <tr><td><strong>** Edict 13</trong></td><td><strong>Ashoka's victory over Kalinga (old name of Odisha)</strong></td></tr>
            <tr><td>Edict 14</td><td>Describes engraving of inscriptions in different parts of the country.</td></tr>
        </table>
        ...
        <p><strong>Pillar Edicts</strong></p>
        <ul>
            <li><strong>Total: 7</strong> (meaning: 7 lines)</li>
            <li><strong>Delhi Topra Pillar Edict:</strong> It comprises all the 7 Ashokan Pillar Edicts and the <strong>7th Edict</strong> is considered as the <strong>longest</strong> amongst them all. Only one language <strong>(Prakrit)</strong> and only one script <strong>(Brahmi)</strong> is used. Delhi Topra Pillar was transferred from <strong>Haryana</strong> to in <strong>Delhi</strong> by <strong>Firoz Shah Tughlaq</strong>. The painted illustration of the moving of the Ashoka Pillar at Topra is found in <strong>Sirat-i-Firuz Shahi</strong>.</li>
            <li><strong>Ashoka Pillar, Sarnath:</strong> It was adopted as the National Emblem on <strong>26th Jan 1950</strong>. Here, Ashoka commemorated the first Sermon of Buddha. <strong>Animals: Lion, Elephants, Horse, Bull</strong>.</li>
            <li><strong>Rampurva Bull:</strong> Placed in President House. Found in Bihar.</li>
        ...
        <h4 style="color:#F59E0B;">Mauryan Administration</h4>
        <ul>
            <li><strong>Saptanga Theory by Kautilya:</strong> He mentioned <strong>7 elements</strong> to rule an administration effectively. 1. Raja: King, 2. Amatya: Secretary, 3. Janpada: Territory, 4. Durga: Fort, 5. Kosha: Treasury, 6. Danda: Army, 7. Mitra: Friend.</li>
        </ul>
        ...
        <ul>
            <li>Tax paid in gold: <strong>Hiranya</strong>.</li>
            <li>Emergency tax: <strong>Pranaya</strong>.</li>
            <li>Taxes paid in kind by villages: <strong>Pindakara</strong>.</li>
            <li>Army maintenance tax: <strong>Senabhaktam</strong>.</li>
            <li>Extra tax: <strong>Parsvam</strong>.</li>
        </ul>
        <p><strong>Two Types of Courts</strong></p>
        <ul>
            <li>1. <strong>Dharmasthiya Nyayalaya:</strong> Presided by <strong>Vyavaharika</strong> (personal disputes).</li>
            <li>2. <strong>Kantakasodhana Nyayalaya:</strong> Presided by <strong>Pradeshta</strong> (disputes between state and people).</li>
        </ul>
        <p><strong>Officers</strong></p>
        <ul>
            <li><strong>Sannidhata:</strong> Chief treasury officer (CTO)</li>
            <li><strong>Samaharta:</strong> Collector general of revenue</li>
            <li><strong>Gopa:</strong> Responsible for account</li>
            <li><strong>Akshapatalik:</strong> Accountant General/ Audit Officer</li>
            <li><strong>Nagaraka:</strong> Responsible for city administration</li>
            <li><strong>Sitadhyaksha:</strong> Superintendent of Agriculture</li>
            <li><strong>Samsthadhyaksha:</strong> Responsible for market</li>
            <li><strong>Navadhyaksha:</strong> Superintendent of ships</li>
            <li><strong>Ashwadhyaksha:</strong> Commanding officer of the cavalry</li>
            <li><strong>Shulkadhyaksha:</strong> Superintendent of Toll Tax</li>
            <li><strong>Akaradhyaksha:</strong> Superintendent of Mines</li>
            <li><strong>Dhamma Mahamatta:</strong> New post created by Ashoka to check if people are following the concepts of Dhamma</li>
        </ul>
        <p><strong>Indica - Account of the Mauryan Empire by Megasthenes</strong></p>
        <ul>
        ...
        <ul>
            <li><strong>Kautilya</strong> proposes a <strong>seven-part structure</strong> for the state including the king, ministers, territory, forts, treasury, military, and allies (also known as <strong>saptanga theory</strong>)</li>
            <li><strong>Women</strong> occupied <strong>higher positions</strong> in society and were a part of <strong>Army</strong>.</li>
        </ul>
        <p><strong>Society & Administration</strong></p>
        <ul>
            <li>Society was divided into <strong>4 varnas</strong>. Social order based on the <strong>Dharma, Varna</strong> and <strong>Ashrama</strong> systems.</li>
            <li><strong>Antyaja:</strong> Without any caste.</li>
            <li><strong>8 types</strong> of marriages were mentioned and <strong>divorce was allowed</strong></li>
            <li><strong>Provincial Administration:</strong> Divided in: <strong>Centre, Province</strong> and <strong>District</strong> Unit. District Unit (<strong>Vishaya and Ahara</strong>).</li>
            <li><strong>Silver</strong> was extensively used for <strong>coinage</strong> in the Mauryan Empire.</li>
            <li><strong>Sthanika:</strong> Head of several villages. <strong>Gramika:</strong> Head of the village.</li>
            <li><strong>Provincial Officers:</strong> <strong>Kumar or Aryaputra or Pradeshika:</strong> Provincial head. <strong>Mahamatya:</strong> Senior Administration officer. <strong>Amatya:</strong> Executive officials. <strong>Yukta:</strong> Revenue Assessment. <strong>Rajjuka:</strong> Judicial officers.</li>
            <li><strong>Recruitment:</strong> Tribes used as troops, spies, and assassins.</li>
            <li><strong>Ports:</strong> West: <strong>Bharuch (Gujarat), Sopara (Maharashtra)</strong>. East: <strong>Tamralipti (Bengal)</strong>.</li>
        ...
        <ul>
            <li><strong>Founder:</strong> <strong>Pushyabhuti</strong>. They were ruling in <strong>Thaneshwar</strong> (now in Haryana).</li>
            <li><strong>Son:</strong> <strong>Prabhakarvardhan</strong>. <em>Prabhakarvardhan had two sons and a daughter:</em> <strong>Rajyavardhana</strong> (eldest), <strong>Harshavardhana</strong> (youngest), <strong>Rajyashri</strong> (daughter) who married <strong>Grahavarman</strong> (he was a member of the Maukhari Dynasty, ruling at kannauj).</li>
            <li>Grahavarman was killed by the combined armies of <strong>Devgupta</strong> (Ruler of Malwa) and <strong>Shashanka</strong> (Ruler of Gauda). Subsequently, Rajyavardhana was also killed. Harshvardhana took revenge by defeating the Gauda King Shashanka.</li>
        </ul>
        <p><strong>Harshavardhana (606 AD-647 AD)</strong></p>
        <ul>
            <li><strong>Capital:</strong> <strong>Kannauj</strong>.</li>
            ...
            <li><strong>Arunashva</strong> (Governor under Harsha) ruled after Harsha but could not establish a dynasty.</li>
        </ul>
        <p><strong>Hiuen-Tsang / Xuang-Zang:</strong></p>
        <ul>
            <li><strong>"nd</strong> Chinese Traveller (1400 years ago). He stayed in India for about 15 years.</li>
            <li>He traveled extensively under the patronage of Emperor <strong>Harshavardhana</strong>.</li>
            <li>His writings, <strong>"Si-yu-ki" (Records of the Western World)</strong>, provide invaluable insights into Indian society, religion, education, and administration.</li>
        </ul>
        <p><strong>Assemblies:</strong></p>
        <ul>
            <li><strong>Kannauj:</strong> To honour Hiuen -Tsang.</li>
            <li><strong>Prayag:</strong> Organised every 5 years at the confluence of Ganga, Yamuna, and Saraswati. Known as the origin of the Kumbh tradition (first historical evidence of Kumbh Mela).</li>
        </ul>
        <p><strong>Inscription:</strong></p>
        <ul>
            <li><strong>Banskhera inscription:</strong> it is a 7th-century CE (628 CE) <strong>copper plate</strong> grant issued by Harshavardhana, discovered in <strong>Shahjahanpur</strong>, Uttar Pradesh. It has Harshavardhan's <strong>personal signature</strong>.</li>
            <li><strong>Madhuban copper plate inscription & Sonpat inscription</strong> - are also <strong>epigraphical sources</strong> about Harsha's reign.</li>
            <li>Harshavardhan's <strong>Vallabhi conquest</strong> is found in - <strong>Navsari copper plate Inscription</strong>.</li>
        </ul>
        <h4 style="color:#F59E0B;">Maukhari Dynasty</h4>
        <ul>
            <li><strong>Ishanvarman</strong>, an important ruler of Maukhari Dynasty took title of <strong>Maharajadhiraja</strong>.</li>
        </ul>
        <h4 style="color:#F59E0B;">Ikshvaku Dynasty</h4>
        <ul>
            <li><strong>Founder:</strong> <strong>Chintamula 1</strong>.</li>
            <li><strong>Time period:</strong> 3rd - 4th century CE.</li>
            <li><strong>Capital:</strong> <strong>Vijayapuri</strong> (identified with Nagarjunkonda).</li>
            <li><strong>Region:</strong> Lower Krishna - Guntur valley (modern Andhra Pradesh).</li>
        </ul>
        <h4 style="color:#F59E0B;">Vishnukundin Dynasty</h4>
        <ul>
            <li><strong>Capital:</strong> Amarapuram or Amravati.</li>
        </ul>

        <h3>12. Chalukyas & Pallavas</h3>
        <h4 style="color:#F59E0B;">Chalukya Dynasty</h4>
        <ul>
        ...
        <p><strong>Badami Chalukya</strong></p>
        <ul>
            <li><strong>Jayasimha:</strong> He was the first ruler of this dynasty. <strong>Capital: Vatapi</strong>.</li>
            <li><strong>Pulakeshin I (543 AD-566 AD):</strong> He was the founder of <strong>Badami Chalukya Dynasty</strong>. <strong>Pulakeshin I had two son: Kirtivarman I</strong> and <strong>Mangalesha</strong> (Mangalesh was killed by Kirtivarman I's son <strong>Pulakeshin II</strong>, who later ascended the throne).</li>
            <li><strong>Pulakeshin II (610 AD-642 AP):</strong> He is considered the <strong>greatest ruler</strong> of this dynasty. After defeating Harshavardhana, <strong>Pulakeshin II</strong> took the title of <strong>"Dakshinapatheshwara"</strong> (Lord of South). <strong>Titles of Pulakeshin II:</strong> Satyashraya, Bhattaraka, Maharajadhiraja, Parameshwara, Prithvivallabha. He also defeated <strong>Mahendravarman I</strong> (Pallava ruler) in the <strong>Battle of Pullalur</strong>. He was defeated in the <strong>Battle of Vatapi</strong> (642 CE) by <strong>Narasimhavarman I</strong> (son of Mahendravarman I), who then assumed the title <strong>"Vatapikonda"</strong> (Conqueror of Vatapi). <strong>Aihole Pillar Inscription</strong> (Karnataka) was about Pulakeshin II, composed by his court poet <strong>Ravikirti</strong>.</li>
            <li><strong>Vikramaditya I:</strong> He was the third son of Pulakeshin II. He recovered <strong>Vatapi</strong> from Pallavas. His great grandson <strongKirtivarman II (last ruler of Badami Chalukya)</strong> was defeated by <strong>Dantidurga</strong> who later founded Rashtrakuta Dynasty.</li>
        </ul>
        <p><strong>Chalukyan Architecture</strong></p>
        <ul>
            <li>Chalukyan Temple architecture is divided into three groups:</li>
            <li><strong>Aihole:</strong> Known as Laboratory of Indian Temple Architecture. Examples: <strong>Ravana Phadi Caves</strong>, <strong>Lad Khan Temple</strong> (Dedicated to Shiva), <strong>Durga Temple</strong> (Example of <strong>Gaja-Prishta</strong> form of architecture, Originally dedicated to God 'Surya', Located in 'Bagalkot', Karnataka, Known for its unique apical design. <em>Gaja-Prishta: Elliptical shaped formation seen in Dravid or Vesara form of Architecture</em>), <strong>Huchimalligudi temple, Aihole</strong> (Shiva Temple built around the 7th century by the Early Chalukyas), <strong>Meguti Jain Temple</strong> (Only Jain temple at Aihole. Contains the <strong>Aihole inscription</strong> of Ravikirti).</li>
            <li><strong>Badami:</strong> Famous for rock-cut cave temples. <strong>Badami Rock Cut Caves:</strong> Four major rock-cut caves carved into sandstone cliffs showcasing Shaiva, Vaishnava, and Jain traditions side by side.</li>
            <li><strong>Pattadakal:</strong> Blend of Nagara (North Indian) and Dravida (South Indian) styles. <strong>Pattadakal group of temple:</strong> A total of 10 temples seen here: 4 (Nagara style) and 6 (Dravida style). Declared as <strong>UNESCO World Heritage Site</strong> in 1987. Pattadakal group of temples are known as <strong>"Cradle of Indian Architecture"</strong>. Examples: <strong>Virupaksha Temple</strong> (Dedicated to Lord Shiva. Built in: Dravida style. Built by: <strong>Queen Lokamahadevi</strong>), <strong>Papanatha temple</strong> (Based on Mixed architecture style: Nagara+Dravid. Part of Pattadakal group), <strong>Sangameshwara Temple</strong> (Dravida style. Dedicated to Lord Shiva), <strong>Galaganatha Temple</strong> (Nagara style), <strong>Mallikarjuna temple</strong> (Built by <strong>Trilokadevi</strong>, wife of Vikramaditya 2).</li>
        </ul>

        <h4 style="color:#F59E0B;">Pallava Dynasty (575 AD-897 AD)</h4>
        <ul>
            <li><strong>Founder:</strong> <strong>Simha Vishnu</strong>.</li>
            <li><strong>Capital:</strong> <strong>Kanchipuram</strong>.</li>
            <li>Pallavas were feudatories to <strong>Kalabhras</strong>.</li>
            <li>They developed the Dravida architecture temples.</li>
            <li><strongGreatest ruler:</strong> Mahendravarman I.</li>
        </ul>
        <p><strong>Mahendravarman I (600 AD - 630 AP)</strong></p>
        <ul>
            <li>Patron of Rock-cut Architecture.</li>
            <li>Initially Mahendravarman was Jain then converted to Hinduism (Shaivaites).</li>
            <li>Son: Narasimhavarman 1.</li>
        </ul>
        <p><strong>Narasimhavarman I (630 AD - 668 AD)</strong></p>
        <ul>
            <li><strong>Title taken:</strong> <strong>Mahamalla</strong> and <strong>Vatapikonda</strong>.</li>
            <li>He started the <strong>Monolithic Rock</strong> cut temple.</li>
            <li>He founded the <strong:port city Mahabalipuram</strong>.</li>
            <li><strong>Last ruler:</strong> <strong>Aparajitavarman</strong> defeated by Chola king <strong>Aditya I</strong> in 897 AD.</li>
        </ul>
        <p><strong>Pallava Architecture</strong></p>
        <ul>
        ...
        <ul>
            <li><strong>Capital:</strong> <strong>Manyakheta</strong> (Modern day Malkhed, Karnataka).</li>
            <li>Known for their military strength, patronage of literature, and support of Jainism and Shaivism.</li>
        </ul>
        <p><strong>Dantidurga (735 AD - 756 AP)</strong></p>
        <ul>
            <li>Founded the Rashtrakuta dynasty by overthrowing the Chalukyas of Badami.</li>
            <li><strong>Assumed titles:</strong> <strong>Prithvivallabha, Rajadhiraj</strong>.</li>
            <li><strong>Sanjan Plates</strong> (Copper-plate inscription of Dantidurga): Records victories over Kalinga, Malava, Lata, Tanka, Koshala, and the Gurjara king Nagabhata I.</li>
            <li>Performed the <strong>Hiranyagarbha</strong> Mahadana ritual at Ujjain to assert <strong>Kshatriya</strong> status.</li>
            <li>Defeated <strong>Kirtivarman II</strong>, the last ruler of the Badami Chalukyas.</li>
        </ul>
        <p><strong>Krishna I (756 AD - 774 AP)</strong></p>
        <ul>
            <li>He was the successor and paternal uncle of Dantidurga. Patron of Shaivism. Continued military campaigns against Chalukyas and Pallavas.</li>
            <li>Constructed <strong>Kailashnatha temple</strong> at Ellora. Built by <strong>Krishna I</strong>, it is the World's <strong>largest Monolithic</strong> Rock Cut Temple. Present at <strong>16th</strong> Ellora cave. Added to UNESCO World Heritage site in <strong>1983</strong> along with Ajanta - Ellora caves. <strong>Aurangzeb</strong>, the Mughal Emperor, once attempted to destroy the temple.</li>
        </ul>
        <p><strong>Govinda II:</strong> Son of Krishna I, weak ruler, short reign, no significant conquests.</p>
        <p><strong>Dhruva Dharavarsha (780 AD - 793 AD)</strong></p>
        <ul>
        ...
        <ul>
            ...
            <li>Considered the most aggressive Rashtrakuta ruler during the Tripartite Struggle.</li>
            <li>Inscriptions claim victories over Gurjaras, Andhra Pradesh, Kerala and even Lanka. He conquered <strong>Himalaya to Kaveri</strong>.</li>
        </ul>
        <p><strong>Amoghavarsha I (814 AD - 878 AD)</strong></p>
        <ul>
            <li>Son of Govinda III and great grandson of Krishna 1. <strong>Real name:</strong> <strong>Sarva</strong> (before coronation). <strong>Assumed title:</strong> <strong>"Nripatunga"</strong>.</li>
            <li>He converted to Jainism and patronised Jainism. Patron of literature and grammar.</li>
            <li>He was disciple of <strong>Acharya Jinasena</strong>, who authored the <strong>Adi Purana</strong> during his reign.</li>
            <li><strong>Saktayana</strong>, grammarian in his court, composed <strong>Amoghavritti</strong> (Sanskrit grammar).</li>
            <li>Amoghavarsha himself authored: <strong>Kavirajamarga</strong> (earliest known Kannada literary work) and <strong>Prashnottara Ratnamalika</strong> (in Sanskrit).</li>
            <li>Referred to as <strong>"Ashoka of the South"</strong> for his non-violent policies and Jain influence.</li>
        </ul>
        <p><strong>Krishna II:</strong> Faced stiff resistance from <strong>Eastern Chalukyas</strong> and <strong>Cholas</strong>. Could not expand the empire like his predecessors and saw stagnation in territorial expansion.</p>
        <p><strong>Indra III (914 AD - 928 AD)</strong></p>
        <ul>
            <li>Briefly restored Rashtrakuta supremacy by occupying Kannauj during the Tripartite Struggle, defeating Pratihara <strong>Mahipala I</strong>.</li>
        ...
        <ul>
            ...
            <li>Took the grand imperial <strong>title: Akhilakshtrakuta Chakravartin</strong> (Universal Emperor of all Rashtrakutas).</li>
            <li>Defeated <strong>Eastern Chalukyas</strong>, maintaining supremacy in the Deccan.</li>
            <li>At the peak of his reign, controlled territory from <strong>Gujarat</strong> to <strong>Tanjore</strong>.</li>
        </ul>
        <p><strong>Khottiga (967 AD - 972 AP)</strong></p>
        <ul>
            <li>Also Known as <strong>Karka II</strong>. Karka II Defeated by <strong>Tailopa II</strong> who established Later Chalukya.</li>
            <li>Faced attack from Paramara ruler <strong>Siyaka II</strong>, who sacked the Rashtrakuta capital Manyakheta, marking the start of Rashtrakuta decline. This attack significantly weakened the dynasty. Manyakheta was destroyed, marking a symbolic end of Rashtrakuta power.</li>
        </ul>
        <p><strong>Indra IV (973 AD - 982 AP)</strong></p>
        <ul>
            <li>Last Rashtrakuta Ruler. Committed <strong>Sallekhana</strong>, the Jain ritual of voluntary death by <strong>fasting</strong>.</li>
            <li>Power passed to the Western Chalukyas of Kalyani, under Tailapa II.</li>
            <li>Tailapa II was once a feudatory of the Rashtrakutas and founded a new dynasty, Chalukyas of Kalyani.</li>
        </ul>
        <p><strong>Architecture (Rashtrakutas)</strong></p>
        <ul>
        ...
        <h4 style="color:#F59E0B;">Dynasties that emerged after the Rashtrakutas and Their Regional Influence</h4>
        <table border="1" style="border-collapse: collapse; width: 100%; border-color:#334155; margin-bottom:20px;">
            <tr style="background:#0F172A;"><th>Dynasty</th><th>Region</th><th>Relation to Rashtrakutas</th></tr>
            <tr><td>Western Chalukyas (Kalyani)</td><td>Karnataka</td><td>Direct successors</td></tr>
            <tr><td>Paramaras</td><td>Malwa</td><td>Former Feudatories</td></tr>
            <tr><td>Kalachuris (Tripuri)</td><td>Madhya Pradesh</td><td>Regional beneficiaries</td></tr>
            <tr><td>Yadavas (Seuna)</td><td>Maharashtra</td><td>Former Feudatories</td></tr>
            <tr><td>Eastern Chalukyas</td><td>Andhra Pradesh</td><td>Strengthened & Expanded due to vacuum</td></tr>
            <tr><td>Cholas</td><td>Tamil Nadu</td><td></td></tr>
        </table>
        
        <p><strong>Chalukyas of Kalyani (Later Chalukyas)</strong></p>
        <ul>
            <li><strong>Period:</strong>973-1189 CE. <strong>Founder:</strong> Tailapa II. <strong>Capital:</strong> Kalyani. <strongFamous Ruler:</strong> Vikramaditya VI. <strong>Architecture:</strong> Gadag style. <strong>Successors:</strong> Hoysalas.</li>
        </ul>
        <p><strong>Parmar Dynasty</strong></p>
        <ul>
            <li><strong>Region:</strong> Malwa. <strong>Capital:</strong> Dhara. <strong>Famous Ruler:</strong> Raja Bhoja. <strong>Architecture:</strong> Malwa Nagara style. <strong>Origin:</strong> Ex-feudatories of Rashtrakutas.</li>
            <li>Statue of <strong>Raja Bhoja</strong>, a legendary Indian king from the 11th century. Location: The 32-foot-high bronze statue is located at the Upper Lake in <strong>Bhopal</strong>, Madhya Pradesh, India.</li>
            <li>Raja Bhoja wrote a book <strong>"Sarasvatikanthabharana"</strong>. <strong>Bhojatal Lake</strong> of Bhopal provides 40% water supply. Paramaras were devotees of Shiva.</li>
        </ul>
        <p><strong>Kalachuri Dynasty</strong></p>
        <ul>
            <li><strong>Capital:</strong> Tripuri (MP). <strong>Period:</strong> 9th-12th CE. <strong>Religion:</strong> Shaivism. <strong>Architecture:</strong> Central Indian Nagara. <strong>Key Ruler:</strong> Lakshmikarna. <strong>Famous Region:</strong> Amarkantak.</li>
        </ul>
        <p><strong:Hoysala Dynasty</strong></p>
        <ul>
            <li>They were feudatory to <strong>Chalukyas of Kalyani</strong>. <strong>Capital:</strong> <strong>Dwarasamudra (Halebidu)</strong>. <strong>Founder:</strong> <strong>Nripa Kama II</strong>.</li>
            <li><strong>Period:</strong> 10th-14th CE. <strong>Greatest Ruler:</strong> Vishnuvardhana. <strong>Architecture:</strong> Stellate soapstone temples, Gadag style. <strong>Successors:</strong> Vijayanagara Empire.</li>
            <li><strong>Lakkundi Temple (Vesara style):</strong> Developed during later Chalukyas (Kalyani).</li>
            <li><strong>Somnathpura Temple (Karnataka):</strong> Built by: Hoysala Dynasty.</li>
            <li><strong>Chennakeshava Temple (Belur, Karnataka):</strong> Star-shaped temple. Built by: <strong>King Vishnuvardhana</strong>. Style of architecture: <strong>Bhumija style</strong> of architecture. Dedicated to: Lord Vishnu. Chenna means <em>'Beautiful'</em> and Keshava means <em>'Vishnu'</em>. Built in <strong>soapstone</strong> (chloritic schist).</li>
            <li><strong:Hoysaleswara Temple (Halebidu, Karnataka):</strong> <strong>42nd UNESCO World Heritage</strong> site. Dedicated to: Lord Shiva. <strong>3 Jain Basadis</strong> are within the complex.</li>
        </ul>
        <p><strong>Yadava Dynasty:</strong> Capital: <strong>Devagiri</strong>.</p>
        <p><strong>Kakatiyas:</strong> Capital: <strong>Warangal</strong>.</p>
        <p><em>Quick Revisions:</em> Pulakeshin II defeated Harshavardhana. Pulakeshin II defeated Mahendravarman I. Narsimhavarman I defeated Pulakesin II.</p>

        <h3>13. Tripartite Struggle and Cholas</h3>
        <h4 style="color:#F59E0B;">Tripartite Struggle</h4>
        <ul>
            <li>A prolonged political and military conflict between 8th - 10th CE to control Kannauj, a symbol of imperial legitimacy in North India. It is also known as <strong>Kannauj Triangle War</strong>.</li>
            <li>Fought among three powerful dynasties: 1. <strong>Palas:</strong> East India (Bengal region). 2. <strong>Pratiharas:</strong> West and Central India (Rajasthan, MP, Gujarat). 3. <strong>Rashtrakutas:</strong> Deccan (Maharashtra and Karnataka).</li>
        </ul>
        ...
        <ul>
            <li><strong>Founder:</strong> <strong>Hemanta Sena</strong> (c. 1095 AD). <strong>Real Founder:</strong> <strong>Vijaysena</strong>.</li>
            <li><strong>Capital:</strong> <strong>Vijayapura</strong>. Highly Centralised Monarchy. The Sena Dynasty ruled Bengal after the Pala dynasty (11th-12th century AD. </li>
            <li>During Sena Dynasty rule <strong>Jaydeva</strong> wrote <strong>Gita Govinda</strong>. They revived Brahmanism (orthodox Hinduism) in Bengal.</li>
            <li><strong>Rulers:</strong> Ballala Sena, Lakshman Sena. Ballala Sena introduced <strong>'Kulinism'</strong>. His successor, Vijaya Sena, reigned for over 60 years, solidifying the dynasty's control.</li>
            <li><strong>Dhakeshwari Temple</strong> in Dhaka was built in the 12th century CE by King <strong>Ballala Sen</strong>.</li>
            <li>In 1204 <strong>Bakhtiyar Khilji</strong> attacked <strong>Lakshman sena</strong> and ended the Sena Dynasty.</li>
        </ul>
        <p><strong>Gurjara Pratihara</strong></p>
        <ul>
            <li><strong>Capital:</strong> <strong>Kannauj/Bhinmal</strong>. Founder of the dynasty: Nagabhatta I. Defeated Arab forces in Rajasthan (Battle near Broach) in the 8th century. <em>Agnikul Theory related to Gurjar Pratihars is written in the Prithviraj Raso.</em></li>
            <li><strong>Nagabhatta I (730 AD - 760 AD)</strong>.</li>
            <li><strong>Vatsaraja:</strong> First Pratihara king to enter the <strong>Tripartite Struggle</strong> for Kannauj. Faced defeat by <strong>Dharmapala</strong> (Pala king).</li>
            <li><strong>Nagabhatta II:</strong> He recovered Kannauj. He defeated <strong>Dharmapala</strong> but was defeated by <strong>Govinda III</strong> (Rashtrakuta ruler).</li>
            <li><strong>Ramabhadra:</strong> Son of Nagabhata II (a weak ruler, short reign).</li>
            <li><strong>Mihir Bhoja or Bhoja I (836 AD - 885 AD):</strong> <strong>Most powerful ruler</strong> of the Gurjara-Pratihara dynasty. He extended the empire from Gujarat to Bengal. <strong>Adopted divine title: Adivaraha</strong> (Boar incarnation of Vishnu). Coins issued with Varaha Image (boar symbol). Described by Arab travelers (like <strong>Sulaiman</strong
) as: <em>"Enemy of Islam"</em> and one of the four great kings of the world in their view.</li>
            <li><strong>Gwalior Inscription:</strong> Record defeat of <strong>Govinda III's</strong> army at <strong>Sagar Tal</strong> (though Rashtrakutas claim the opposite). Proclaims Bhoja's power and victory in <strong>Madhya Bharat</strong>. Defeated Devapala (Pala ruler) in battle. Reasserted Pratihara supremacy in the Kannauj region.</li>
            <li><strong>Mahendrapala (885 AD - 910 AD):</strong> Son of Mihira Bhoja. Successfully maintained the strength and prosperity of the Pratihara empire. Ruled over a vast territory from Punjab to Bengal. Launched a <strong>military campaign</strong> against <strong>Kashmir</strong>: Fought with <strong>Shankaravarman</strong> (Karkota ruler of Kashmir) and was defeated in the campaign. His court became a major center of Sanskrit learning and literature. He patronized <strong>Rajashekhara</strong>, a celebrated Sanskrit poet and dramatist, often called the <em>"Kalidasa of the Pratiharas."</em></li>
            <li>Under Mahendrapala's patronage, Rajashekhara composed several important works: <strong:Karpuramanjari</strong> - Prakrit play (the only known Prakrit drama of that time). <strong>Viddhasalabhanjika</strong> - Sanskrit drama. <strong>Bal Ramayana</strong> - Condensed version of the Ramayana. <strong>Bal Mahabharata</strong> - Condensed version of the Mahabharata. <strong>Harivilasa</strong> - Epic work on Lord Krishna. <strong>Bhuvanakosha</strong> - Descriptive geography of the known world. <strong>Kavyamimamsa</strong> - Treatise on literary criticism and theory.</li>
            <li><strong>Mahipala I:</strong> He was defeated by <strong>Indra III</strong>, the Rashtrakuta ruler, around 915 CE. This defeat led to the loss of Kannauj and marked the beginning of the Pratihara Empire's decline.</li>
            <li><strong>Bhoja II:</strong> A weak ruler, under whose reign internal conflicts weakened the empire.</li>
            <li><strong>Vijayapala:</strong> He ruled during the decline of the Pala dynasty and lost many territories to rival powers.</li>
            <li><strong>Rajyapala:</strong> Led during <strong>Mahmud of Ghazni's</strong> invasion in 1018 CE, offering no resistance. His inaction was widely condemned, and he was later killed by the Chandela ruler <strong>Vidyadhara</strong> for capitulating to Mahmud.</li>
            <li><strong>Trilochanapala:</strong> He ruled during the collapse of the Pratihara state.</li>
            <li><strong>End of Dynasty:</strong> The Pratiharas lost power due to <strong>external invasions</strong>, and <strong>internal fragmentation</strong> among feudatories. Their decline marked the end of the Tripartite Struggle (Pratiharas-Palas-Rashtrakutas) for control of Kannauj.</li>
        </ul>

        <h4 style="color:#F59E0B;">Chola Dynasty (300 BC-1279 AD)</h4>
        <ul>
        ...
        <p><strong>Rulers of Chola Dynasty</strong></p>
        <ul>
            <li><strong>Vijayalaya:</strong> He is the <strong>founder</strong> of Imperial Chola Dynasty. He built the <strong>Nishumbhasudini</strong> Temple in <strong>Thanjavur</strong>.</li>
            <li><strong>Aditya I:</strong> Son of Vijayalaya. Defeated <strong>Aparajita</strong>, the last Pallava ruler, and established the Chola supremacy.</li>
            <li><strong>Parantaka I:</strong> He defeated the <strong>Pandya</strong> King and the <strong>Ruler of Sri Lanka</strong>. Took the title <strong>Maduraikonda</strong>. Built the <strong>Netaraja Temple</strong> in <strong>Chidambaram</strong> (Tamil Nadu).</li>
        </ul>
        <p><strong>Rajaraja Chola I (985 AD-1014 AD)</strong></p>
        <ul>
            <li>He was the <strong>greatest ruler</strong> of the Chola Dynasty. <strong>Titles:</strong> Mummidi Chola, Maltanda Chola.</li>
            <li>He conquered <strong>No Republic of Maldives</strong> and <strong>Northern Sri Lanka</strong>.</li>
            <li>He built <strong>Brihadeshwara Temple</strong> also known as <strong>Rajarajeshwara Temple</strong> in Thanjavur (Tamil Nadu). Dedicated to Lord Shiva.</li>
        </ul>
        <p><strong>Rajendra Chola I (1014 AD-1044 AD)</strong></p>
        <ul>
            <li>He was the son of Rajaraja Chola I.</li>
            <li>He annexed the whole of <strong>Sri Lanka</strong>.</li>
            <li>Rajendra I was the first Indian king to take his army across the <strong>Bay of Bengal</strong> to defeated <strong>Srivijaya</strong> or <strong>Sailendra Empire</strong> (Indonesia).</li>
            <li>He defeated <strong>Mahipala</strong> (Pala ruler) in Bengal. And assumed the title of <strong>"Gangaikonda" or "Gangaikondachola"</strong>.</li>
            <li>After winning over Palas, He established a new capital called <strong>Gangaikondacholapuram</strong> and built a <strong>Shiva Temple</strong>.</li>
        </ul>
        <p><strong>Rajendra Chola II</strong></p>
        <ul>
            <li>He defeated the <strong>Chalukya King</strong> <strong>Someshwara</strong>.</li>
            <li>He provided a significant grant to a music dynasty, facilitating the establishment of a <strong>Music School</strong>.</li>
        </ul>
        <p><strong>Last Ruler:</strong> <strong>Rajendra III</strong>.</p>
        <p><strong>Culture and Architecture</strong></p>
        <ul>
            <li><strong>Artapakitti:</strong> Bronze Image of Lord Shiva made during Chola dynasty.</li>
            <li><strong>Tirumurai:</strong> A Compilation of poems and hymns in praise of Lord Shiva by the <strong>Nayanar</strong> saints in the <strong>Tamil language</strong>. The eleventh volume is composed by <strong>Karaikkal Ammaiyar</strong>.</li>
            <li><strong>Great Living Chola Temples:</strong> These were built during the Chola Empire in the <strong>Dravidian</strong> style of temple architecture. Built by Chola kings between 11th and 12th centuries CE. Collectively, they are a <strong>UNESCO World Heritage</strong> Site (added in 1987 and 2004).</li>
            <li><strong>Three Major Temples:</strong>
                <ul>
                    <li><strong>Brihadisvara Temple</strong> at Thanjavur.</li>
                    <li><strong>Brihadisvara Temple</strong> at Gangaikondacholapuram.</li>
                    <li><strong>Airavatesvara Temple</strong> at Darasuram.</li>
                </ul>
            </li>
        </ul>
        <h3>14. Chandels, Chauhans &amp; Temple Architecture</h3>
        <h4 style="color:#F59E0B;">Chandel Dynasty</h4>
        <ul>
            <li><strong>Founder:</strong> Nannuka. <strong>Capital:</strong> Khajuraho.</li>
            <li>They were feudatories of the <strong>Gurjara Pratiharas</strong> and ruled in the <strong>Jejakabhukti</strong> region (Bundelkhand, modern day MP - UP) for about 500 years (from the 9th to the 13th century).</li>
        </ul>
        <p><strong>Yashovarman (925 - 950 CE)</strong></p>
        <ul>
        ...
        <ul>
            ...
            <li>Built several magnificent temples at Khajuraho, including the <strong>Vishvanatha Temple</strong> and <strong>Parshvanatha Temple</strong>, reflecting his patronage of both <strong>Shaivism</strong> and <strong>Jainism</strong>.</li>
            <li>Ended his life by voluntary drowning in the sacred confluence of Prayag (Allahabad), a ritual known as <em>Jal Samadhi</em>.</li>
        </ul>
        <p><strong>Vidyadhara (1003 - 1035 CE)</strong></p>
        <ul>
            <li>Defended the Khajuraho region against <strong>Mahmud of Ghazni's</strong> invasions, emerging as one of the few Indian rulers to successfully resist him.</li>
            <li>Commissioned the construction of the <strong>Kandariya Mahadeva Temple</strong>, the largest and most ornate of the Khajuraho group of temples.</li>
        </ul>
        <h4 style="color:#F59E0B;">Chauhan Dynasty (8th - 12th CE)</h4>
        <ul>
            <li><strong>Founder:</strong> <strong>Vasudeva Chauhan</strong>.</li>
            <li><strong>Capital:</strong> Shakambhari (present-day Sambhar, Rajasthan) and later <strong>Ajmer</strong>.</li>
            <li>Grew in power as feudatories of the <strong>Gurjara-Pratiharas</strong>, eventually asserting independence.</li>
            <li>Commanded a strategic position in North-central India (Rajasthan, parts of Gujarat, and Haryana).</li>
        </ul>
        <p><strong>Ajayaraja II (1110 - 1135 CE)</strong></p>
        <ul>
            <li>Established the city of <strong>Ajayameru</strong> (present-day <strong>Ajmer</strong>), making it the new Chauhan capital.</li>
            <li>Constructed the <strong>Taragarh Fort</strong> (Also known as Ajaymeru Durg) on a hilltop in Ajmer, strengthening the dynasty's defenses.</li>
            <li>Issued silver coins bearing his name and the name of his queen, Somalladevi, signifying his sovereign status.</li>
        </ul>
        <p><strong>Arnoraja (1135 - 1150 CE)</strong></p>
        <ul>
            <li>Son of Ajayaraja II. Continued the expansion of the Chauhan empire, conflicting with the Chalukyas of Gujarat.</li>
            <li>Commissioned the construction of <strong>Ana Sagar Lake</strong> in Ajmer.</li>
        </ul>
        <p><strong>Vigraharaja IV (Bisaldew) (1150 - 1164 CE)</strong></p>
        <ul>
            <li>Expanded the Chauhan empire to its zenith, capturing Delhi (Dhillika) from the <strong>Tomaras</strong> and controlling a vast territory from the Vindhyas to the Himalayas.</li>
            <li>Authored the Sanskrit play <strong>Harikeli</strong> Nataka.</li>
        ...
        <ul>
            ...
            <li><strong>Second Battle of Tarain (1192 CE):</strong> Defeated by <strong>Muhammad Ghori</strong>, marking a decisive turning point in Indian history and paving the way for Islamic rule in North India.</li>
            <li>His life and exploits are romanticized in the epic poem <strong>Prithviraj Raso</strong>, composed by his court poet <strong>Chand Bardai</strong>.</li>
        </ul>
        <h4 style="color:#F59E0B;">Temple Architecture</h4>
        <ul>
